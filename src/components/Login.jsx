      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center p-4">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center space-y-6">
            ...
            <div>
              <h1 className="text-4xl text-white mb-2 drop-shadow-lg">AI Forensic Assistant</h1>
          ...
          {/* Glassmorphism Demo Credentials */}
            ...
            <div className="relative">
              ...
              <div className="text-sm space-y-3 text-white/60">
                <div className="flex items-center gap-3">
                  ...
                  <span><strong className="text-blue-300">Investigator:</strong> detective.chen / forensics123</span>
                </div>
                <div className="flex items-center gap-3">
                  <div className="w-2 h-2 bg-indigo-400 rounded-full"></div>
                  <span><strong className="text-indigo-300">Admin:</strong> admin.johnson / forensics123</span>
                </div>
              </div>
            </div>
          </div>
